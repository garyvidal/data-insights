  ...
  var xdmpFuncs = ("xp:dereference xinc:node-expand xinc:link-references xinc:link-expand xhtml:restructure xhtml:clean " +
                  "xhtml:add-lists xdmp:zip-manifest xdmp:zip-get xdmp:zip-create xdmp:xquery-version xdmp:word-convert " +
                  "xdmp:with-namespaces xdmp:version xdmp:value xdmp:user-roles xdmp:user-last-login xdmp:user xdmp:url-encode " +  
                  "xdmp:url-decode xdmp:uri-is-file xdmp:uri-format xdmp:uri-content-type xdmp:unquote xdmp:unpath " + 
                  "xdmp:triggers-database xdmp:trace xdmp:to-json xdmp:tidy xdmp:subbinary xdmp:strftime xdmp:spawn-in " +
  ...
  function startComplete() {
    ...
    if (/^[\w$_\.\-]*:$/.test(token.string)) {
      token = tprop = {start: cur.ch, end: cur.ch, string: "", state: token.state,
                       className: token.string == ":" ? "function" : null};
    }
